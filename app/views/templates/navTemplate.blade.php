			...
			<div class="panel-body">
				...
				<form method="get" action="{{URL::to('search')}}">
					<div class="form-group ">
						...
						<select data-placeholder="Choose a Country..." tabindex="1" class="form-control selectRoute1" name="from" id="from">
					...
					<div class="form-group ">
						...
						<select data-placeholder="Choose a Country..." tabindex="1" class="form-control selectRoute2" name="to">
							...
							<option class="selectRoutes" selected id="to3" value="Munoz, Nueva Ecija">Munoz, Nueva Ecija</option>
					...
					<div class="form-group">
						<button id="goButton" class="btn btn-primary btn-large form pull-right">Go!</button>
					</div>
				</form>
			</div>
		</div>
